...
export const Filters: FC<IFilters> = ({
  selectedCity, setSelectedCity, history, selectedBuilding, setSelectedBuilding, selectedRooms, dispatch, getBuildingsForDropdown
}) => {
  ...
  const handleCitySelect = (e: ChangeEvent<{ value: unknown }>, history: History) => {
    ...
    getFilteredMRs(e.target.value as string, history, '', selectedRooms , dispatch);
  ...
  const handleBuildingSelect = (
    ...
    getFilteredMRs(selectedCity, history, evt.target.value as string, selectedRooms, dispatch);
  };
